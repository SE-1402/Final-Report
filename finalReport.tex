...
The solution chosen was to use a PIC32MX795 microcontroller to receive CAN data from the controller on the operating machine. The PIC32 communicates with a WRT Node module that runs a web socket for wireless communication with the android device replacing the Virtual Terminal.\\
